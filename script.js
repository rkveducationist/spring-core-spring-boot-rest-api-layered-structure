...
doc.setFontSize(16)
doc.text("1. Spring Core • IoC • DI • Annotation-based config 2. Spring Boot REST API • Spring Initializr • application.properties • Layered architecture: o Controller o Service o Repository • CRUD APIs • Exception handling • Validation 3. Spring Data JPA • @Entity", 20, y)
